...
class _StandardDefaults(__UserDefinedDefaults):
    ...
    responses = _Responses({
        "del_self": "&#13;",
        "del_process": "удаление ожидай<br>(я не умею удалять смс от админов чата)",
        "del_success": "✅ *....успешноудалено....*",
        "del_err_924": "❗ Не прокатило. Дежурный администратор? 🤔",
        "del_err_vk": "❗ Не прокатило. Ошибка VK:{ошибка}",
        "del_err_not_found": "❗ А что удалить та нада ? 🤷‍♀",
        "del_err_unknown": "❗ Неизвестная ошибка при удалении 👀",
        "chat_subscribe": "Чат распознан 👍<br>Идентификатор<br>{имя}<br>Иди во вселенной ириса: {ид}",
        "chat_bind": "Чат '{имя}' привязан!",
        "user_ret_ban_expired": "💚 Срок бана пользователя {ссылка} истек",
        "user_ret_process": "💚 Добавляю пользователя {ссылка}",
        "user_ret_success": "✅ Пользователь {ссылка} успешно добавлен в беседу",
        ...
        "info_duty": "Информация о дежурном:<br>Alias Duty v{версия}<br>Владелец: {владелец}<br>Чатов: {чаты}<br><br>Информация о чате:<br>Iris ID: {ид}<br>Имя: {имя}",
        "info_myself": "Информация о дежурном:<br>Aieas Duty v{версия}<br>Владелец: {владелец}<br>Чатов: {чаты}<br><br>Информация о чате:<br>Iris ID: {ид}<br>Имя: {имя}",
        ...
        "trusted_success_add": "✅ П{ссылка} в доверенных",
        "trusted_success_rem": "✅ {ссылка} удален из доверенных",
